...
const GalaxisCard = _ref => {
  ...
  useEffect(() => {
    if (metadata.sides && metadata.sides.length >= 1 && metadata.sides[0].original_height && metadata.sides[0].original_width) {
      ...
      let originalWidth = metadata.sides[0].original_width; //console.log(width, height);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, loading && /*#__PURE__*/React.createElement(SpinnerCircular, {
    ...
    alt: "undefined"
  }), ' '))), metadata.traits && /*#__PURE__*/React.createElement(React.Fragment, null, metadata.traits.map((elem, metadataIndex) => elem.icon_url ? /*#__PURE__*/React.createElement(React.Fragment, null, parseInt(elem.status) === 1 && /*#__PURE__*/React.createElement("div", {
    className: "trait-holder",
    style: {
      clipPath: "url(#svgPath)"
    },
